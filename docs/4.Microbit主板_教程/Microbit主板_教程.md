...
在我们开始学习keyes 人体感应套件之前，首先介绍Micro:bit主板，它是所有项目的核心。
...
② LED 点阵：由一个一个的 LED 灯组成，灯从大的方向来说就只有两种状态：开和关，也就是我们平时说的亮和灭，但是从明和暗这个方向来说，它又可以分成不同的等级，也就是我们平时说的亮一点，就好比是成绩，分数可以从 0 到 100，划分不同的层次。这个点阵可以用来显示：图像，文字，数字等。同时这些 LED 灯还是一个光线传感器。
...
| :--: | :--: | :--: | 
|Micro:bit主板*1|面包板*1|Micro:bit扩展板*1|
|![图片不存在](./media/da669743d7e2f9e1880430b0ab12ca06.png)|![图片不存在](./media/a6ff46e05db89a18ffe62f2f6c66c701.png)|![图片不存在](./media/11f324f82f890b0691f134e1ea7a3765.png)  |
|人体红外热释传感器模块*1|MicroUSB线*1|220Ω电阻*1|
|![图片不存在](./media/dda94299cc2abaff2c9cb8ff7ce365ff.jpg)| ![图片不存在](./media/8d920d12138bd3b4e62f02cecc2c63a3.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
|公对母杜邦线若干|面包板连接线若干|红色LED*1|  


3. 项目接线图：

![图片不存在](./media/1725e84ff0e4339d49d194ee224d4197.png)

4. 项目代码：

![图片不存在](./media/d1dc646676e570fabe63e04622a4f05b.png)

5. 项目现象：

按照接线图正确接好各元器件，将代码上传至Micro:bit主板。上传成功后，利用MicroUSB线连接到计算机上电，可以看到的现象是：当人体红外热释传感器检测到附近有人经过时，人体红外热释传感器上的红灯灭，Micro:bit主板上的LED点阵显示“❤”图案，LED灯快速闪烁；否则，人体红外热释传感器模块上的红灯亮，Micro:bit主板上的LED点阵显示“![图片不存在](./media/40e15fe724a77972c60a823e879eb4e0.png)”图案，LED熄灭。

![图片不存在](./media/70b8828aee7106d585c0a0c34a405b78.jpg)
