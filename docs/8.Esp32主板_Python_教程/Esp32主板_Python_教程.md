...
![图片不存在](./media/8e6ddba419099e9a3e35ca111da204d1.png)
...
![图片不存在](./media/efb2a83f0de61b430dc185cc1c4996c6.png)
...
![图片不存在](./media/19f690025686d38f53b17742b1a967dc.png)
...
![图片不存在](./media/e47925d68d049ed5f5c6152a212851a1.png)
...
![图片不存在](./media/44f1bbdda14d9d133c8600a4b023cdb7.png)
...
![图片不存在](./media/253ef2eb1dbbe4686841d02dc1c944a3.png)
...
![图片不存在](./media/0ae33e780d6cbcada224d1ed06217d89.png)
...
按照接线图正确接好模块，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：当传感器检测到附近有人在运动时，value值为1，模块上LED熄灭，串口监视器显示“**1   Somebody is in this area!**”；没有检测到附近有人在运动时，value值为0，模块上LED点亮，串口监视器显示“**0   No one!**”。

![图片不存在](./media/961e61773f9d20f2a44cfa7fad77cd90.jpg)

![图片不存在](./media/90161e6ebb727c81fbaaa618d801551e.png)
...
|![图片不存在](./media/074ca02db99706884ece5ca5c9adece4.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/da669743d7e2f9e1880430b0ab12ca06.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |
...
![图片不存在](./media/9b5b2083f1d297c36fa55b5fb791b25a.png)
...
![图片不存在](./media/5758d644809c738f2d063c5fdcebd817.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：当人体红外热释传感器检测到附近有人经过时，人体红外热释传感器模块上的红灯灭，LED灯快速闪烁。

![图片不存在](./media/61e4263e4d5351de8adc0127d3c8b981.jpg)
...
![图片不存在](./media/5b17493f1e38f8aaa90ac2adc38ffe80.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：当人体红外热释传感器检测到附近有人经过时，人体红外热释传感器模块上的红灯灭，有源蜂鸣器发出警报，LED灯快速闪烁。
